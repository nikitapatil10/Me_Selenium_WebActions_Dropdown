...
public class SingleSelectDropDown {
	...
	public void getDefaultOption(WebElement webElement) {
		...
		// TODO: Print the text
		System.out.println("The default value is: "+defaultValue.getText());
	}
	...
	public void printOptions(WebElement webElement) {
		...
		System.out.println("All options available in dropdown are: ");
	...
	public void run() throws MalformedURLException {
		...
		// "country"
		// WebElement country;
		WebElement country = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[2]/div/div/select"));
		...
		WebElement movies = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[3]/div/div/select"));
		...
		WebElement fruits = driver.findElement(By.xpath("/html/body/div/div/div[2]/div[2]/div[4]/div/div/select"));
